  ...
  return (
    <div className='min-h-screen bg-black text-white'>
      ...
      <section className='relative flex pt-40 justify-center overflow-hidden'>
        ...
        <div className='absolute inset-0 bg-[url("/starry-bg.png")] opacity-10'></div>
        {/* Floating Bubbles */}
            ...
            <div className='relative'>
              ...
              <div className='relative bg-black/20 backdrop-blur-md rounded-lg p-1.5 border border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.03)]'>
                <div className='flex items-center'>
                  <input 
                    type="text" 
                    placeholder="Drop any product link here..." 
                    className='w-full bg-black/30 backdrop-blur-sm rounded-l-md px-4 py-2 text-white placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-white/20 transition-all duration-300'
                  />
                  <button className='bg-black/40 hover:bg-black/50 px-4 py-2 rounded-r-md transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)]'>
